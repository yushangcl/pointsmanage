...
public class ExchangeRecordAction {
	@Resource
	...
	public ModelAndView detailIndex(@RequestParam(value="exchangeRecords", defaultValue="")String exchangeRecordsStr,
		...
		System.out.println("exchangeRecords:"+exchangeRecords);
	...
	public @ResponseBody JsonBean save(
		...
		System.out.println("exchangeRecordsSave:"+exchangeRecordsStr);
		String message = "";
		...
		Integer exchangeRecords = Integer.valueOf(exchangeRecordsStr);
		...
		if(StringUtils.isBlank(clientMobile)){
			...
			if(!StringUtils.isBlank(exchangeRecordsStr)){
				exchangeRecord = exchangeRecordService.selectByPrimaryKey(exchangeRecords);
			}
		}
